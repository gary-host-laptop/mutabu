...
async function saveSettings() {
    await Store.set('nt_profile_images', profileImages);
    await Store.set('nt_bg_images', bgImages);
    await Store.set('nt_engines', engines);
    await Store.set('nt_clock_theme', clockTheme);
    await Store.set('nt_widget_layout', widgetLayout);
    await Store.set('nt_ui_lang', uiLang);
    await Store.set('nt_title_lang', titleLang);
    await Store.set('nt_location', userLocation);
    await Store.set('nt_username', document.getElementById('username-input').value.trim());
    await Store.set('nt_font_latin', fontLatin);
    await Store.set('nt_font_jp',    fontJp);
    await Store.set('nt_font_clock', fontClock);
    await Store.set('nt_bg_blur',       bgBlur);
    await Store.set('nt_search_target', searchTarget);
    await Store.set('nt_clock_format',  clockFormat);
    await Store.set('nt_clock_seconds', clockSeconds);
    await Store.set('nt_jlpt_level',    jlptLevel);
